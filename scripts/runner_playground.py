...
config = {
    "G" : ["montgomery"],
    "budget": [i for i in range(100, 1000, 50)],
    "transmission_rate": [0.078],
    "compliance_rate": [i/100 for i in range(30, 100, 5)],
    "global_rate":  [i/100 for i in range(5, 100, 5)],         #ranges are not currently inclusive of upper bound
    "discovery_rate": [i/100 for i in range(5, 100, 5)],
    "snitch_rate":  [i/100 for i in range(5, 100, 5)],
