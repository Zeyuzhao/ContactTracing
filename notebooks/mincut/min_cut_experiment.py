...
config = {
    ...
    "budget": [500, 600, 700, 800, 900, 1000, 1100, 1200, 1300],
...
run = GridExecutorParallel.init_multiple(
    config, in_schema, out_schema, func=min_cut_evaluation, trials=5)
